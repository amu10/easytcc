...
public final class BranchTransaction implements Serializable {
    ...
    public BranchTransaction(String branchId, String xid, String name, String beanName,
                             String confirmMethod, String cancelMethod, Object[] arguments) {
        this.branchId = branchId; this.xid = xid; this.name = name; this.beanName = beanName;
        this.confirmMethod = confirmMethod; this.cancelMethod = cancelMethod;
